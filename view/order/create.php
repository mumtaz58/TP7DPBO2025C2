...
<form action="index.php?page=order&action=store" method="POST">
    <div>
        ...
        <select id="flower_id" name="flower_id" required onchange="updatePrice()">
            ...
            <?php foreach($flowers as $flower): ?>
                <option value="<?= $flower['flower_id'] ?>" data-price="<?= $flower['price'] ?>">
    ...
    <div>
        ...
        <input type="number" id="quantity" name="quantity" min="1" value="1" required onchange="updateTotalPrice()" onkeyup="updateTotalPrice()">
    </div>
